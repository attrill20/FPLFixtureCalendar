      ...
      <section className="section-white">
        <div className="home-sub-heading">
          ...
          <ul>
            ...
            <li><Link to="/top10"><strong>Player Stats</strong></Link> - Explore a range of player lists for different point scoring metrics and filter by position, price or club 🏆 </li>
