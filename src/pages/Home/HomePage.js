    ...
    <div>
      ...
      <div className="home-sub-heading">
        ...
        <ul>
          ...
          <li><Link to="/search"><strong>Player Searcher Tool</strong></Link> - allows comparison between player's stats to help you pick your next transfer </li>
      ...
      <div>
        ...
        <div className="fdr-wrapper">
          ...
          <div className="fdr-heading">  
            <h2>July 2024 Fixture Guidance - Bottom Teams</h2>
