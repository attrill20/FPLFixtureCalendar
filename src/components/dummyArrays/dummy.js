...
export let teams = [
  ...
  { id: 7, name: "Chelsea", initial: "CHE", badge: CHEbadge, h_diff: 5, a_diff: 4 },
  { id: 8, name: "Crystal Palace", initial: "CRY", badge: CRYbadge, h_diff: 5, a_diff: 2 },
  { id: 9, name: "Everton", initial: "EVE", badge: EVEbadge, h_diff: 6, a_diff: 3 },
  { id: 10, name: "Fulham", initial: "FUL", badge: FULbadge, h_diff: 3, a_diff: 6 },
  // { name: "Leicester City", initial: "LEI", badge: LEIbadge },
  // { name: "Leeds United", initial: "LEE", badge: LEEbadge },
  { id: 11, name: "Liverpool", initial: "LIV", badge: LIVbadge, h_diff: 7, a_diff: 10 },
  { id: 12, name: "Luton", initial: "LUT", badge: LUTbadge, h_diff: 2, a_diff: 2 },
